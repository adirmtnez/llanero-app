...
interface BodegonProductsTableProps {
  products: Array<{
    id: string
    name: string
    sku?: string
...
export function BodegonProductsTable({ products, onProductDeleted }: BodegonProductsTableProps) {
  ...
  const handleEdit = (product: { id: string }) => {
    router.push(`/admin/bodegones/productos/${product.id}/editar`)
  }
