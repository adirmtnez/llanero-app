...
interface SPABodegonProductFormProps {
  product?: BodegonProduct | null // For edit mode
  mode: 'create' | 'edit'
}

export function SPABodegonProductForm({ product, mode }: SPABodegonProductFormProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6">
          <div className="flex items-center gap-2">
            <Button 
              ...
              variant="ghost" 
              size="sm" 
              onClick={() => navigate("/bodegones/productos")}
            >
