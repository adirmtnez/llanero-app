...
export function RestaurantesSubcategoriasPage() {
  ...
  // Filter subcategories based on active tab and search
  ...
  const breadcrumbItems = [
    ...
    { label: 'Subcategorías', path: '/restaurantes/productos/sub-categorias', isActive: true }
  ]
      ...
      <div className="flex flex-1 flex-col gap-6 p-4 pt-6 md:pt-0 max-w-[1080px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <h1 className="text-2xl font-bold">Subcategorías de Restaurante</h1>
          </div>
            ...
            <div className="text-center space-y-3">
              ...
              {!searchQuery && (
                <p className="text-sm text-muted-foreground">
                  Comienza agregando tu primera subcategoría de restaurante
                </p>
              )}
              {searchQuery && (
                <p className="text-sm text-muted-foreground">
