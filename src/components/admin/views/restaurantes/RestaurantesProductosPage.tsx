...
export function RestaurantesProductosPage() {
  ...
  const breadcrumbItems = [
    ...
    { label: 'Productos', path: '/restaurantes/productos', isActive: true }
  ]
      ...
      <div className="flex flex-1 flex-col gap-6 p-4 pt-6 md:pt-0 max-w-[1080px] mx-auto w-full">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Button 
              ...
              onClick={() => navigate("/restaurantes/productos/agregar")}
            >
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center space-y-6 py-16">
            ...
            <Button onClick={() => navigate("/restaurantes/productos/agregar")}>
              <Plus className="h-4 w-4 mr-2" />
