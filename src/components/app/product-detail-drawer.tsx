...
export default function ProductDetailDrawer({
  ...
  return (
    <Sheet open={internalOpen} onOpenChange={(open) => {
      ...
      <SheetContent side="bottom" className="h-[90vh] rounded-t-[30px] [&>button]:hidden [&[id^='radix-']]:!gap-0">
        ...
        <div className="px-6 py-4 overflow-y-auto flex-1">
          {/* Imagen del producto */}
          <div className="w-full h-64 bg-black rounded-[20px] mb-4 flex items-center justify-center relative overflow-hidden">
            <div className="w-full h-full bg-gradient-to-br from-green-600 to-green-800 rounded-[20px] flex items-center justify-center">
              <span className="text-white text-6xl">{product.emoji}</span>
            </div>
          ...
          <div className="mb-8">
            ...
            <button className="text-sm text-blue-600 mt-1">Ver más...</button>
          </div>
        </div>
